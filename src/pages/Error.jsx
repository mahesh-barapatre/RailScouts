...
const Error = () => {
  return (
    <div
      className="h-full w-full flex flex-col justify-center items-center space-y-9 bg-cover bg-center"
      style={{
    ...
    >
      ...
      <h1 className="text-3xl text-red-500">
        You are currently not in any station. Please check your location.
      </h1>
      <h1 className="text-3xl text-red-500">
